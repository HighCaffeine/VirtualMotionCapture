...
namespace SimpleCapture
{
    public class SimpleCapture : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            EditorGUILayout.LabelField("ScreenShotPath (default: Pictures Folder)");
            ...
            if (GUILayout.Button("Capture"))
            {
                ...
                {
                    path = Path.Combine(Environment.GetEnvironmentVariable("USERPROFILE"), "Pictures", "VMS ScreenShot/");
                }
                else
                {
                    path = Path.Combine(screenShotPath, "ScreenShot/");
                }
                ...
                Debug.Log(string.Format($"ScreenShot Save : {name}"));
